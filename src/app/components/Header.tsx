...
const Header = () => {
    return (
      <div className="text-center mb-4">
        ...
        <p className={`text-xl text-gray-700 dark:text-gray-300 ${angkor.className} `}>to Reach Your Desired <span className="text-purple-400">Amount</span>  at the least amount of <span className="text-gray-400">Time</span>.</p>
      </div>
    );
  };
